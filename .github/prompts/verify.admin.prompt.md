...
5. ユーザーから承認を得たら、[共通ワークフロー](.github/prompts/WORKFLOW.md) に従い、ブランチ `feature/verify-assignment` を作成してください。
...
8. [共通ワークフロー](.github/prompts/WORKFLOW.md) に従い、変更をコミット（`fix:` プレフィックス）し、リモートリポジトリにプッシュしてください。
